package rt.sg.racsystemtest.serial;
...
import rt.sg.racsystemtest.serial.listener.OnOpenSerialPortListener;
import rt.sg.racsystemtest.serial.listener.OnSerialPortDataListener;
import rt.sg.racsystemtest.serial.thread.SerialPortReadThread;
    ...
    private void startReadThread() {
        mSerialPortReadThread = new SerialPortReadThread(mFileInputStream) {
            ...
            public void onDataReceived(byte[] bytes) {
                Log.i(TAG,"SerialPortReadThread out: " + new String(bytes));
                Log.i(TAG,"SerialPortReadThread out: " + SerialPortManager.this);
                if (null != mOnSerialPortDataListener) {
                    Log.i(TAG,"SerialPortReadThread : " + new String(bytes));
